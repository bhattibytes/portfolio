      ...
      <ResponsiveAppBar />
        <div className={styles.about}>
          ...
          <p>
           ...
           <br></br>
           <br></br>
           For the last few years, I've been learning full stack JavaScript. In 2021, I attended and graduated from <a href='https://www.hackreactor.com/' rel='noopener noreferrer' target="_blank"><strong>Hack Reactor</strong></a>, an immersive full stack software engineering bootcamp. This truly transformational experience set the foundation and helped me to where I am today. Currently, I'm Co-founder and Product Engineer at <a href='https://www.charla.cc/' rel='noopener noreferrer' target="_blank"><strong>Charla Technologies, Inc.</strong></a> and the Lead Software Engineer at <a href='https://www.cyberriskalliance.com/' rel='noopener noreferrer' target="_blank" ><strong>CyberRisk Alliance</strong></a>
           <br></br>
           <br></br>
