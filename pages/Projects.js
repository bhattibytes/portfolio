  ...
  return (
    <div>
      ...
      <div className={styles.projects}>
        <h1>Charla Technologies, Inc. - Side Project turned into Company</h1>
        <p className={styles.summary}>
        Charla allows users to automatically monitor online communities such as Slack and Discord. The application creates data visualizations from conversations happening in the community, keyword tracking and real-time brand alerts, and monitor sentiment analysis and community health. Charla integrates with sales automation tools to automatically alert sales reps of leads, important conversations, and augment CRM prospect data. Following this layer we're creating a way for users to create and view unified profiles of individuals across large social media channels and community platforms to further enrich the data. 
        </p>
        {/* <--------------------START HERE ADD ScreenShots of Charla----------------> */}
        <h1>Catwalk - Eccomerce Project</h1>
        <p className={styles.summary}>
        ...
        <Image src={overview} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={related} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={ratings} width={1000} height={700}/>

        <h1>Secure Your Vote - Capstone Project</h1>
        <p className={styles.summary}>
        ...
        <Image src={home} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={signup} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={address} width={1000} height={700}/>
        <Image src={map} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={state} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={dashboard} width={1000} height={700}/>
        <Image src={vote} width={1000} height={700}/>
