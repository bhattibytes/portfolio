  ...
  return (
    <div>
      ...
      <div className={styles.projects}>
        ...
        <Image src={dash} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={quick} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={lead} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={keywords} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={health} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={reports} width={1000} height={700}/>
        <p className={styles.overview}>
        ...
        <Image src={word} width={1000} height={700}/>
