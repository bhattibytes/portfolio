  ...
  return (
    <div>
      ...
      <div className={styles.projects}>
        ...
        <Image src={dash} width={1474} height={895}/>
        <p className={styles.overview}>
        ...
        <Image src={quick} width={1479} height={899}/>
        <p className={styles.overview}>
        ...
        <Image src={lead} width={1767} height={899}/>
        <p className={styles.overview}>
        ...
        <Image src={keywords} width={1768} height={898}/>
        <p className={styles.overview}>
        ...
        <Image src={health} width={1768} height={900}/>
        <p className={styles.overview}>
        ...
        <Image src={reports} width={1770} height={899}/>
        <p className={styles.overview}>
        ...
        <Image src={word} width={1765} height={895}/>
        ...
        <Image src={home} width={1825} height={938}/>
        <p className={styles.overview}>
        ...
        <Image src={signup} width={1919} height={928}/>
        <p className={styles.overview}>
        ...
        <Image src={address} width={1914} height={930}/>
        <Image src={map} width={1137} height={543}/>
        <p className={styles.overview}>
        ...
        <Image src={state} width={1136} height={542}/>
        <p className={styles.overview}>
        ...
        <Image src={dashboard} width={1915} height={934}/>
        <Image src={vote} width={1136} height={542}/>
        ...
        <Image src={overview} width={1590} height={939}/>
        <p className={styles.overview}>
        ...
        <Image src={related} width={1443} height={899}/>
        <p className={styles.overview}>
        ...
        <Image src={ratings} width={1583} height={935}/>
      </div>
      <Footer />
    </div>
  )
